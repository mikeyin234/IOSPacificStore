...
//////////////////////////////////////////////////////////////////////
//我的電子贈卷
class ElectronVoucherListViewController: BaseViewController ,
...
//============================================
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            cell.LoaElectronVoucherData(dictionary: m_ListConsumeInfo[indexPath.row], strUnit: "元")
   ...
   override func viewDidLoad() {
    ...
    {
        m_labelLimitDate.text  = "";
        m_labelLimitDate.isHidden =  true;
    }

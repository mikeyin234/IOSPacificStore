...
class QLotteryViewController: BaseViewController ,
...
//============================================
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if(m_iType == 0 )
        {
            ...
            cell.LoadData(dictionary: m_ListConsumeInfo[indexPath.row],strUnit: "Q")
        ...
        }else
        {
            ...
            let cell = ElectronVoucherTableViewCell(style: .default, reuseIdentifier: "ElectronCeremony")
            
            cell.LoadData(dictionary: m_ListCollectInfo[indexPath.row] , strUnit: "張")
   ...
   override func viewDidLoad() {
    ...
    DCUpdater.shared()?.queryPointsBalance(ConfigInfo
                                         .m_strAccessToken, andWalletType: "Q,T");
...
override  func viewWillDisappear(_ animated: Bool) {
  ...
  //電子抵用卷
  @IBAction func onQClick(_ sender:UIButton)
  {
  ...
  ////////////////////////////////////////////////////////////////
  //電子禮卷
  @IBAction func onLotteryClick(_ sender:UIButton)
  {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if(m_iType == 0)
        {
            let btSubNavBrandMain
                       = StoryBoard.instantiateViewController(withIdentifier: "QLotteryList") as! QLotteryListViewController
            
            btSubNavBrandMain.m_dataDirectory = m_ListConsumeInfo[indexPath.row]
            btSubNavBrandMain.m_strTitle  =  "Q點";
            self.navigationController?.pushViewController(btSubNavBrandMain, animated: true)            
        }else
        {
            let btSubNavBrandMain
                       = StoryBoard.instantiateViewController(withIdentifier: "LotteryList") as! LotteryListViewController
            
            btSubNavBrandMain.m_dataDirectory = m_ListCollectInfo[indexPath.row]
            
            btSubNavBrandMain.m_strTitle  =  "摸彩券";
            self.navigationController?.pushViewController(btSubNavBrandMain, animated: true)
        }

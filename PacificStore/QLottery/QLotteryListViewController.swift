...
//////////////////////////////////////////////////////////////////////
//我的電子贈卷
class QLotteryListViewController: BaseViewController ,
                                     UITableViewDelegate,UITableViewDataSource{
    
//============================================
    var m_iType  = 0;
    
    var m_ListQLottery:[NSDictionary] =  [];
...
//================================================//
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = ElectronVoucherTableViewCell(style: .default, reuseIdentifier: "QLottery")
        
        cell.LoaQLotterydData(dictionary: m_ListQLottery[indexPath.row]  , strUnit: "Q")
        
        Mycell = cell;
        
        Mycell.selectedBackgroundView = selectedBackgroundView;
...
//=============================================================================//
     ...
     selectedBackgroundView.backgroundColor = UIColor(red: 0xE6/255, green: 0xE6/255, blue: 0xE6/255, alpha: 1)
        ...
        if(strSuccess.isEqual(to: "YES"))
        {
            ...
            if(Int(strCode) == 0)
            {
                ...
                for DataDicCur  in dataArray
                {
                    ...
                    m_ListQLottery.append(DataDicCur);
                }

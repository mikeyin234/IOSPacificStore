...
class NewsDetailViewController: BaseViewController,WKUIDelegate,WKNavigationDelegate,YTPlayerViewDelegate{
    ...
    @objc func tapHandler(_ sender: UIGestureRecognizerDelegate) {
            ...
            StarPlayYoutube(identifier:m_strYoutubeFile);
            m_bIsPause  = true;
      }
    ...
    func StarPlayYoutube(identifier:String)
          {
              ...
              self.navigationController!.pushViewController(ControlYoutube, animated: true)

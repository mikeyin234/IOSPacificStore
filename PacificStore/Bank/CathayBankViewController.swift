//
//  CathayBankViewController.swift
//  PacificStore
//
//  Created by 尹竑翰 on 2019/9/1.
...
class CathayBankViewController: BaseViewController,WKUIDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let myURL = URL(string:ConfigInfo.CATHAYBK_SITE)

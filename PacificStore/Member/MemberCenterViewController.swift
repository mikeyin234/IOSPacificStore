...
//=======================did Get Activity Game Result============================//
            ...
            NotificationCenter.default.addObserver(self, selector:#selector(didDeleteMemberResult), name:NSNotification.Name(rawValue: kDCDeleteMember), object: nil)
...
//===============================================================================================//
    ...
    @objc func didDeleteMemberResult(notification: NSNotification){
